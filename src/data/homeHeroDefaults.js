export const homeHeroDefaults = {
  ...
  subtitle:
    'Выберите прохладную перкаль, гладкий сатин или мягкие комплекты для всей кровати. Редакционные подсказки помогут понять ткань до перехода в карточку товара.',
