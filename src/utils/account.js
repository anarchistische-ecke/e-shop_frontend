...
export const CART_SESSION_STRATEGY = Object.freeze({
  ...
  guestCheckoutMessage:
    'Можно оформить заказ без регистрации. Если войти, мы сохраним данные для следующих покупок, а текущая корзина на этом устройстве останется без изменений.',
  loginMessage:
    'После входа вы сможете быстрее оформлять повторные покупки, видеть историю заказов и не потеряете товары из текущей корзины.',
  loginBenefits: [
    'Сохраняйте контакты и данные получателя для следующих заказов.',
