        ...
        <div className="container mx-auto px-4 max-w-2xl">
          <Card padding="lg">
            ...
            <ol className="list-decimal list-inside space-y-2 mt-4 text-base text-muted">
              ...
              <li>Оплачивайте товары через защищённую форму платёжного сервиса.</li>
              <li>
                Воспользуйтесь банковской картой или системой быстрых платежей (СБП).
              </li>
              <li>
                Оставьте имя, телефон, электронную почту и адрес: менеджер предложит доступные варианты доставки
